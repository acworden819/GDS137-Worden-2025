...
var defaultPlatformsData = [ //platforms that can be touched no matter the color (grey platforms)
	...
	{
		x: 1400, y: canvas.height - 525,  //position
		width: 200, height: 250,  //size
		color: "#f5f5f5",
	},
	{
		x: canvas.width/2	, y: 5,  //position
		width: 10000, height: 50,  //size
		color: "#f5f5f5",
	},
]
...
var colorPlatformsData = [
	...
	{
		x: 1350, y: canvas.height - 850,  //position
		width: 20, height: 800,  //size
		colorGroup: "blue", 
		isDoor: true,
	},
